        ...
        <div class="max-h-[58vh] space-y-3 overflow-y-auto p-4">
          ...
          <div v-if="filteredTaskList.length" class="space-y-2">
            ...
            >
              ...
              <div class="flex items-start justify-between gap-2 text-[10px] text-stone-500 dark:text-zinc-500">
                <span>{{ formatDate(task.updated_at) }}</span>
                <span
                  class="max-w-[240px] break-all text-right font-mono leading-4"
                  :title="task.task_id"
                >
                  #{{ task.task_id }}
                </span>
