...
<template>
  <div class="flex min-h-screen flex-col bg-[#f7f3e8] text-stone-900 dark:bg-zinc-900 dark:text-stone-100">
    <header class="sticky top-0 z-40 border-b border-stone-300/80 bg-[#f7f3e8]/95 backdrop-blur dark:border-zinc-700/60 dark:bg-zinc-900/90">
