...
const selectVariants = cva(
  'h-9 w-full appearance-none rounded-md border border-stone-300 bg-stone-100 px-3 pr-9 text-sm text-stone-700 shadow-xs outline-none transition-[color,box-shadow] disabled:cursor-not-allowed disabled:opacity-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300',
  {
    variants: {
      state: {
