...
- `GET|POST /api/users/me/prompt-templates`
- `GET|POST /api/users/me/providers`
- `PATCH|DELETE /api/users/me/providers/:providerId`
- `GET|POST /api/projects/:id/agents`
- `POST /api/projects/:id/agents/:agentId/activate`
